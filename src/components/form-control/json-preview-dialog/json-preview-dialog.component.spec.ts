...
describe('AswJsonPreviewDialogComponent', () => {
    let component: AswJsonPreviewDialogComponent;
    let fixture: ComponentFixture<AswJsonPreviewDialogComponent>;
    const data: any = [
        {
            icon: 'title',
            displayName: 'Header',
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(AswJsonPreviewDialogComponent);
